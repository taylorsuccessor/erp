<?php include('include/header.php');?>
 ...
 if(isset($_GET['edit_id'])){?>
  ...
  echo great_status('add_quits.php','quits',array('agree','disagree','need more info','delete'));
...
?>
          ...
          function send_data(button_node){
              ...
              my_ajax("add_quits_php.php",sended_data,button_node,function(data){
...
<?php
    ...
    $description='';
if(isset($_GET['edit_id'])){
    $edit_result=mysqli_query($con,'select title,description from quits where id='.$_GET['edit_id'])or die(mysqli_error($con));
...
$inputs_arr=    array(
   ...
   array('type'=>'text','name'=>'title','value'=>$title,'label'=>'quit title'),

    array('type'=>'edit_textarea','name'=>'description','value'=>$description,'label'=>'description'),
