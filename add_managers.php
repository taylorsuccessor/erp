...
?>
          ...
          function send_data(button_node){
              ...
              my_ajax("add_managers_php.php",sended_data,button_node,function(data){
          ...
          function send_edit_data(button_node,edit_id){
              ...
              my_ajax("add_managers_php.php",sended_data,button_node,function(data){alert(data);
                  var data_arr=new Array();data_arr=data.split("||=>||");
...
if(isset($_GET['edit_id'])){
    $edit_result=mysqli_query($con,'select name,password,position,email,phone from managers where id='.$_GET['edit_id'])or die(mysqli_error($con));
...
$inputs_arr=    array(
   ...
   array('type'=>'text','name'=>'name','value'=>$name,'label'=>'manager name'),
      array('type'=>'password','value'=>$password),
      array('type'=>'password','name'=>'repassword' ,'value'=>$repassword,'label'=>'confirm password'),
    array('type'=>'select','name'=>'position','value'=>$position,'options'=>$positions_name,'options_value'=>$positions_id),
